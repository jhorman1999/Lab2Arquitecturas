...
public class ServicioPersistenciaMock implements IServicioPersistenciaMockRemote, IServicioPersistenciaMockLocal {
    ...
    public ServicioPersistenciaMock() {
        if (vendedores == null) {
            ...
            ofertas.add(new Oferta(1L, "Pedro", 245, 10.200));
            ofertas.add(new Oferta(2L, "Mariana", 425, 44.200));
            ofertas.add(new Oferta(3L, "Daniel", 745, 22.200));
            ofertas.add(new Oferta(4L, "Armando", 145, 55.200));
